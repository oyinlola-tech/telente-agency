import svgPaths from "./svg-u05rpqfy28";
import imgContainer from "figma:asset/f842778e62470355285b76ba913f10bc6089f7d9.png";
import imgContainer1 from "figma:asset/c57b54f55fbe8960b068c9e8fa57b30d5e33cc91.png";
import imgContainer2 from "figma:asset/d156ce95b27d9bde35c36bbd8e9db14d94108e27.png";
import imgContainer3 from "figma:asset/43df4d730545501d2c48534a31f89cc5b2583c1e.png";
import imgContainer4 from "figma:asset/e3cb64ae24eeb62225b3f99c80fcbec169490ac0.png";
import imgContainer5 from "figma:asset/45792d0a273615cbe6261b9b00d3d7e04d275656.png";
import imgContainer6 from "figma:asset/5c7e453b1679a53de62dfb0b9b8d1d3c3eec108a.png";
import imgContainer7 from "figma:asset/c01c05ded98dfc8d686a500b56b413b0a3465f11.png";
import imgSubContainer from "figma:asset/b226f513f40323002014adf4315689b8accf4c55.png";
...
function Button1() {
  return (
    <div className="bg-[#0f0f0f] content-stretch flex items-center px-[24px] py-[18px] relative rounded-[12px] shrink-0" data-name="Button">
      <p className="font-['Roboto_Mono:Medium',sans-serif] font-medium leading-[1.5] relative shrink-0 text-[#e7beb1] text-[18px] text-center uppercase whitespace-nowrap">Services</p>
    </div>
  );
}
  ...
  return (
    <div className="bg-[#1a1a1a] flex-[1_0_0] min-h-px min-w-px relative rounded-[14px] self-stretch" data-name="Card">
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col gap-[50px] items-start justify-center px-[60px] py-[90px] relative size-full">
          <Container1 />
          <TextContainer1 />
        </div>
      </div>
...
function SubContainer2() {
  return (
    <div className="content-stretch flex gap-[24px] items-center relative shrink-0 w-full" data-name="Sub Container">
...
function Container5() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[10px] items-center min-h-px min-w-px relative" data-name="Container">
      <Button9 />
      <p className="flex-[1_0_0] font-['Roboto_Mono:Regular',sans-serif] font-normal leading-[1.5] min-h-px min-w-px relative text-[18px] text-white uppercase">Open Project</p>
    </div>
  );
}
...
function Container4() {
  return (
    <div className="flex-[1_0_0] h-[251px] min-h-px min-w-px relative rounded-[20px]" data-name="Container">
      <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-[20px] size-full" src={imgContainer} />
      <div aria-hidden="true" className="absolute border border-[#333] border-solid inset-0 pointer-events-none rounded-[20px]" />
      <div className="flex flex-row items-end size-full">
        <div className="content-stretch flex items-end p-[30px] relative size-full">
          <Container5 />
        </div>
      </div>
    </div>
...
function Container6() {
  return (
    <div className="flex-[1_0_0] h-[251px] min-h-px min-w-px relative rounded-[20px]" data-name="Container">
      <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-[20px] size-full" src={imgContainer1} />
      <div aria-hidden="true" className="absolute border border-[#333] border-solid inset-0 pointer-events-none rounded-[20px]" />
      <div className="flex flex-row items-end size-full">
        <div className="content-stretch flex items-end p-[30px] relative size-full">
          <Container7 />
...
function Container2() {
  return (
    <div className="bg-[#1a1a1a] flex-[1_0_0] min-h-px min-w-px relative rounded-[14px]" data-name="Container">
...
function Container11() {
  return (
    <div className="flex-[1_0_0] h-[251px] min-h-px min-w-px relative rounded-[20px]" data-name="Container">
      <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-[20px] size-full" src={imgContainer2} />
      <div aria-hidden="true" className="absolute border border-[#333] border-solid inset-0 pointer-events-none rounded-[20px]" />
      <div className="flex flex-row items-end size-full">
        <div className="content-stretch flex items-end p-[30px] relative size-full">
          <Container12 />
...
function Container13() {
  return (
    <div className="flex-[1_0_0] h-[251px] min-h-px min-w-px relative rounded-[20px]" data-name="Container">
      <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-[20px] size-full" src={imgContainer3} />
      <div aria-hidden="true" className="absolute border border-[#333] border-solid inset-0 pointer-events-none rounded-[20px]" />
      <div className="flex flex-row items-end size-full">
        <div className="content-stretch flex items-end p-[30px] relative size-full">
          <Container14 />
...
function Container18() {
  return (
    <div className="flex-[1_0_0] h-[251px] min-h-px min-w-px relative rounded-[20px]" data-name="Container">
      <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-[20px] size-full" src={imgContainer4} />
      <div aria-hidden="true" className="absolute border border-[#333] border-solid inset-0 pointer-events-none rounded-[20px]" />
      <div className="flex flex-row items-end size-full">
        <div className="content-stretch flex items-end p-[30px] relative size-full">
          <Container19 />
...
function Container20() {
  return (
    <div className="flex-[1_0_0] h-[251px] min-h-px min-w-px relative rounded-[20px]" data-name="Container">
      <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-[20px] size-full" src={imgContainer5} />
      <div aria-hidden="true" className="absolute border border-[#333] border-solid inset-0 pointer-events-none rounded-[20px]" />
      <div className="flex flex-row items-end size-full">
        <div className="content-stretch flex items-end p-[30px] relative size-full">
          <Container21 />
...
function Container25() {
  return (
    <div className="flex-[1_0_0] h-[251px] min-h-px min-w-px relative rounded-[20px]" data-name="Container">
      <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-[20px] size-full" src={imgContainer6} />
      <div aria-hidden="true" className="absolute border border-[#333] border-solid inset-0 pointer-events-none rounded-[20px]" />
      <div className="flex flex-row items-end size-full">
        <div className="content-stretch flex items-end p-[30px] relative size-full">
          <Container26 />
...
function Container27() {
  return (
    <div className="flex-[1_0_0] h-[251px] min-h-px min-w-px relative rounded-[20px]" data-name="Container">
      <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-[20px] size-full" src={imgContainer7} />
      <div aria-hidden="true" className="absolute border border-[#333] border-solid inset-0 pointer-events-none rounded-[20px]" />
      <div className="flex flex-row items-end size-full">
        <div className="content-stretch flex items-end p-[30px] relative size-full">
          <Container28 />
...
function Container() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[20px] items-start left-[50px] p-[20px] rounded-[24px] top-[903px] w-[1820px]" data-name="Container">
...
function BoldEssentionalUiGhostSmile() {
  return (
    <div className="relative shrink-0 size-[34px]" data-name="Bold / Essentional, UI / Ghost Smile">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 34 34">
        <g id="Bold / Essentional, UI / Ghost Smile">
          <path clipRule="evenodd" d={svgPaths.p48a4200} fill="var(--fill-0, #CE7D63)" fillRule="evenodd" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function SubContainer20() {
  return (
    <div className="content-stretch flex gap-[10px] items-center relative shrink-0" data-name="Sub Container">
      <Button31 />
      <p className="font-['Roboto_Mono:Medium',sans-serif] font-medium leading-[1.5] relative shrink-0 text-[#b3b3b2] text-[20px] uppercase whitespace-nowrap">Visit Website</p>
    </div>
  );
}
...
function SubContainer21() {
  return (
    <div className="bg-[#1f1f1f] content-stretch flex gap-[8px] items-center px-[16px] py-[10px] relative rounded-[45px] shrink-0" data-name="Sub Container">
...
function SubContainer22() {
  return (
    <div className="bg-[#1f1f1f] content-stretch flex gap-[8px] items-center px-[16px] py-[10px] relative rounded-[45px] shrink-0" data-name="Sub Container">
      ...
      <p className="font-['Roboto_Flex:Medium',sans-serif] font-medium leading-[1.5] not-italic relative shrink-0 text-[#e6e6e6] text-[18px] whitespace-nowrap" style={{ fontVariationSettings: "'GRAD' 0, 'XOPQ' 96, 'XTRA' 468, 'YOPQ' 79, 'YTAS' 750, 'YTDE' -203, 'YTFI' 738, 'YTLC' 514, 'YTUC' 712, 'wdth' 100" }}>{`Design & Development`}</p>
    </div>
  );
}
...
function Card4() {
  return (
    <div className="bg-[#1a1a1a] relative rounded-[14px] self-stretch shrink-0 w-[747px]" data-name="Card">
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col gap-[50px] items-start justify-center p-[60px] relative size-full">
          <Container37 />
          <Container38 />
        </div>
      </div>
...
function TextContainer6() {
  return (
    <div className="bg-[#1a1a1a] relative rounded-[14px] shrink-0 w-full" data-name="Text Container">
      <div className="content-stretch flex flex-col font-normal gap-[14px] items-start leading-[1.5] p-[40px] relative w-full">
        <p className="font-['Roboto_Mono:Regular',sans-serif] relative shrink-0 text-[#f9efec] text-[48px] uppercase w-full">Solution</p>
        <p className="font-['Roboto_Flex:Regular',sans-serif] not-italic relative shrink-0 text-[#b3b3b2] text-[18px] w-full" style={{ fontVariationSettings: "'GRAD' 0, 'XOPQ' 96, 'XTRA' 468, 'YOPQ' 79, 'YTAS' 750, 'YTDE' -203, 'YTFI' 738, 'YTLC' 514, 'YTUC' 712, 'wdth' 100" }}>
...
function Container36() {
  return (
    <div className="relative rounded-[20px] shrink-0 w-full" data-name="Container">
      ...
      <div className="content-stretch flex gap-[20px] items-start p-[50px] relative w-full">
        <Card4 />
        <Container39 />
      </div>
    </div>
...
function BoldHandsHandHeart() {
  return (
    <div className="relative shrink-0 size-[34px]" data-name="Bold / Hands / Hand Heart">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 34 34">
        <g id="Bold / Hands / Hand Heart">
          <path d={svgPaths.p46c9080} fill="var(--fill-0, #CE7D63)" id="Vector" />
          <path d={svgPaths.p32315b80} fill="var(--fill-0, #CE7D63)" id="Vector_2" />
        </g>
      </svg>
    </div>
  );
...
function SubContainer25() {
  return (
    <div className="bg-[#1f1f1f] content-stretch flex gap-[8px] items-center px-[16px] py-[10px] relative rounded-[45px] shrink-0" data-name="Sub Container">
      ...
      <p className="font-['Roboto_Flex:Medium',sans-serif] font-medium leading-[1.5] not-italic relative shrink-0 text-[#e6e6e6] text-[18px] whitespace-nowrap" style={{ fontVariationSettings: "'GRAD' 0, 'XOPQ' 96, 'XTRA' 468, 'YOPQ' 79, 'YTAS' 750, 'YTDE' -203, 'YTFI' 738, 'YTLC' 514, 'YTUC' 712, 'wdth' 100" }}>{`Health & Fitness`}</p>
    </div>
  );
}
...
function Container34() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[20px] items-start left-[50px] top-[2991px] w-[1820px]" data-name="Container">
      <SubContainer17 />
      <SubContainer18 />
    </div>
  );
    ...
    <div className="relative shrink-0 w-full" data-name="Text Container">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex items-center justify-center pr-[120px] relative w-full">
          <p className="flex-[1_0_0] font-['Roboto_Flex:Regular',sans-serif] font-normal leading-[1.5] min-h-px min-w-px not-italic relative text-[#676665] text-[18px]" style={{ fontVariationSettings: "'GRAD' 0, 'XOPQ' 96, 'XTRA' 468, 'YOPQ' 79, 'YTAS' 750, 'YTDE' -203, 'YTFI' 738, 'YTLC' 514, 'YTUC' 712, 'wdth' 100" }}>
            At NexGen, we offer a comprehensive suite of digital solutions designed to propel your business to new heights in the digital realm. With a team of skilled professionals, cutting-edge technologies, and a passion for innovation
          </p>
        </div>
      </div>
    </div>
...
function SubContainer39() {
  return (
    <div className="content-stretch flex gap-[20px] items-center relative shrink-0" data-name="Sub Container">
...
function Container62() {
  return (
    <div className="absolute bg-[#0f0f0f] bottom-[20px] content-stretch flex flex-col items-center justify-center left-[20px] overflow-clip p-[20px] rounded-[12px] w-[1167px]" data-name="Container">
      <SubContainer39 />
    </div>
  );
}
...
function Container63() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[10px] items-center min-h-px min-w-px relative" data-name="Container">
      <Button46 />
      <p className="flex-[1_0_0] font-['Roboto_Mono:Regular',sans-serif] font-normal leading-[1.5] min-h-px min-w-px relative text-[18px] text-white uppercase">View Blog</p>
    </div>
  );
}
...
function Container64() {
  return (
    <div className="backdrop-blur-[10px] bg-[rgba(255,255,255,0.2)] content-stretch flex items-center justify-center px-[14px] py-[10px] relative rounded-[10px] shrink-0" data-name="Container">
...
function SubContainer40() {
  return (
    <div className="relative rounded-[20px] self-stretch shrink-0 w-[593px]" data-name="Sub Container">
      <div aria-hidden="true" className="absolute inset-0 pointer-events-none rounded-[20px]">
        <img alt="" className="absolute max-w-none object-cover rounded-[20px] size-full" src={imgSubContainer} />
        <div className="absolute bg-[rgba(206,125,99,0.8)] inset-0 mix-blend-color rounded-[20px]" />
      </div>
      <div className="flex flex-row items-end size-full">
        <div className="content-stretch flex gap-[20px] items-end p-[30px] relative size-full">
          <Container63 />
          <Container64 />
        </div>
      </div>
...
export default function ServicesPageDesktop() {
  return (
    <div className="bg-[#0f0f0f] relative size-full" data-name="Services Page - Desktop">
      <Navbar />
      <Container />
      <Container29 />
      <Container34 />
