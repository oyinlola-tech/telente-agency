import svgPaths from "./svg-7pnnbi6go2";
import imgImage from "figma:asset/8410421760a1d164d08527cf8780ec84c55aa884.png";
import imgImage1 from "figma:asset/41fb78f8a521924f84835648bca5f97d31f489e7.png";
import imgImage2 from "figma:asset/ffd5dce97199b86773a68b59a42d1cfa66e5b456.png";
import imgImage3 from "figma:asset/1708d5ebaf4e0ae55b89b5d6fb1b720dffc07c0b.png";
import imgImage4 from "figma:asset/75cb4a1f7ed7a4cb212ecc32abf92f50404afbb8.png";
import imgImage5 from "figma:asset/136f2a79970377b23d2ef59405879b8f051e3ece.png";
import imgImage6 from "figma:asset/9333dbfd96156981d7444169ea92aa972ca6be65.png";
import imgImage7 from "figma:asset/5cbce443146b069825c04a4d6865200088d3b3f3.png";
import imgImage8 from "figma:asset/50c28168a048d9c7c78df941674e8eee6424fd2f.png";
import imgImage9 from "figma:asset/f4559868741232445220d231eca9a5fd1400bd2c.png";
import imgImage10 from "figma:asset/b78b1abab5fbd8644d7928a37d8134c3e5f10dc1.png";
import imgCard from "figma:asset/44b95835fdeb279271c87fa52b64d34f84a61070.png";
import imgImage11 from "figma:asset/c6312101b508e020b1af49fbf6d06ab49490206b.png";
import imgImage12 from "figma:asset/2011bcbaee24b0431327d9b378a71b4cc54cbe62.png";
import imgImage13 from "figma:asset/78b051ea5bfd363ab0a6dddf635877fcdde3673d.png";
import imgImage14 from "figma:asset/ccd235adb633fc38796cfce3eb01c5a4cca71c79.png";
...
function Button2() {
  return (
    <div className="bg-[#0f0f0f] content-stretch flex items-center px-[24px] py-[18px] relative rounded-[12px] shrink-0" data-name="Button">
      <p className="font-['Roboto_Mono:Medium',sans-serif] font-medium leading-[1.5] relative shrink-0 text-[#e7beb1] text-[18px] text-center uppercase whitespace-nowrap">Projects</p>
    </div>
  );
}
...
function Button5() {
  return (
    <div className="bg-[#0f0f0f] content-stretch flex items-center px-[24px] py-[18px] relative rounded-[12px] shrink-0" data-name="Button">
      <p className="font-['Roboto_Mono:Medium',sans-serif] font-medium leading-[1.5] relative shrink-0 text-[#81807e] text-[18px] text-center uppercase whitespace-nowrap">Blogs</p>
    </div>
  );
}
...
function Container() {
  return (
    <div className="absolute bottom-[1309px] content-stretch flex flex-col gap-[20px] items-start left-[50px] w-[1820px]" data-name="Container">
      <SubContainer />
      <FaqContainer />
    </div>
  );
...
function Button14() {
  return (
    <div className="bg-[#1f1f1f] content-stretch flex items-center justify-center px-[24px] py-[18px] relative rounded-[12px] shrink-0" data-name="Button">
      <p className="font-['Roboto_Flex:Medium',sans-serif] font-medium leading-[1.5] not-italic relative shrink-0 text-[#b3b3b2] text-[18px] text-center uppercase whitespace-nowrap" style={{ fontVariationSettings: "'GRAD' 0, 'XOPQ' 96, 'XTRA' 468, 'YOPQ' 79, 'YTAS' 750, 'YTDE' -203, 'YTFI' 738, 'YTLC' 514, 'YTUC' 712, 'wdth' 100" }}>
        Web Design
      </p>
    </div>
  );
...
function Button15() {
  return (
    <div className="bg-[#ce7d63] content-stretch flex items-center justify-center px-[24px] py-[18px] relative rounded-[12px] shrink-0" data-name="Button">
      <p className="font-['Roboto_Flex:Medium',sans-serif] font-medium leading-[1.5] not-italic relative shrink-0 text-[#0f0f0f] text-[18px] text-center uppercase whitespace-nowrap" style={{ fontVariationSettings: "'GRAD' 0, 'XOPQ' 96, 'XTRA' 468, 'YOPQ' 79, 'YTAS' 750, 'YTDE' -203, 'YTFI' 738, 'YTLC' 514, 'YTUC' 712, 'wdth' 100" }}>
        Web Development
      </p>
    </div>
...
function TabsContainer() {
  return (
    <div className="content-stretch flex gap-[12px] items-start relative shrink-0" data-name="Tabs Container">
      <Button14 />
      <Button15 />
      <Button16 />
    </div>
    ...
    <div className="relative shrink-0 size-[34px]" data-name="Bold / Essentional, UI / Magic Stick 2">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 34 34">
        <g id="Bold / Essentional, UI / Magic Stick 2">
          <path d={svgPaths.p2fe78780} fill="var(--fill-0, #CE7D63)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function SubContainer3() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[14px] items-center min-h-px min-w-px relative" data-name="Sub Container">
      <IconContainer />
      <p className="flex-[1_0_0] font-['Roboto_Flex:Medium',sans-serif] font-medium leading-[1.5] min-h-px min-w-px not-italic relative text-[#f9efec] text-[24px] uppercase" style={{ fontVariationSettings: "'GRAD' 0, 'XOPQ' 96, 'XTRA' 468, 'YOPQ' 79, 'YTAS' 750, 'YTDE' -203, 'YTFI' 738, 'YTLC' 514, 'YTUC' 712, 'wdth' 100" }}>
        Zenith Fitness App
      </p>
    </div>
  );
...
function SubContainer4() {
  return (
    <div className="content-stretch flex gap-[10px] items-center relative shrink-0" data-name="Sub Container">
      <Button17 />
      <p className="font-['Roboto_Mono:Medium',sans-serif] font-medium leading-[1.5] relative shrink-0 text-[#b3b3b2] text-[20px] uppercase whitespace-nowrap">Details</p>
    </div>
  );
}
...
function TextContainer1() {
  return (
    <div className="bg-[#1f1f1f] content-stretch flex gap-[8px] items-center px-[16px] py-[10px] relative rounded-[45px] shrink-0" data-name="Text Container">
      <p className="font-['Roboto_Flex:Regular',sans-serif] font-normal leading-[1.5] not-italic relative shrink-0 text-[#b3b3b2] text-[18px] whitespace-nowrap" style={{ fontVariationSettings: "'GRAD' 0, 'XOPQ' 96, 'XTRA' 468, 'YOPQ' 79, 'YTAS' 750, 'YTDE' -203, 'YTFI' 738, 'YTLC' 514, 'YTUC' 712, 'wdth' 100" }}>
        Category
      </p>
      ...
      <p className="font-['Roboto_Flex:Medium',sans-serif] font-medium leading-[1.5] not-italic relative shrink-0 text-[#e6e6e6] text-[18px] whitespace-nowrap" style={{ fontVariationSettings: "'GRAD' 0, 'XOPQ' 96, 'XTRA' 468, 'YOPQ' 79, 'YTAS' 750, 'YTDE' -203, 'YTFI' 738, 'YTLC' 514, 'YTUC' 712, 'wdth' 100" }}>
...
function Card() {
  return (
    <div className="bg-[#1a1a1a] flex-[1_0_0] min-h-px min-w-px relative rounded-[14px] self-stretch" data-name="Card">
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col gap-[40px] items-start justify-center px-[40px] py-[60px] relative size-full">
          <Container7 />
          <Container8 />
...
function TextContainer3() {
  return (
    <div className="bg-[#1f1f1f] content-stretch flex items-center px-[16px] py-[10px] relative rounded-[45px] shrink-0" data-name="Text Container">
      <p className="font-['Roboto_Mono:Regular',sans-serif] font-normal leading-[1.5] relative shrink-0 text-[#e6e6e6] text-[16px] whitespace-nowrap">React Native</p>
    </div>
  );
}
...
function TextContainer4() {
  return (
    <div className="bg-[#1f1f1f] content-stretch flex items-center px-[16px] py-[10px] relative rounded-[45px] shrink-0" data-name="Text Container">
      <p className="font-['Roboto_Mono:Regular',sans-serif] font-normal leading-[1.5] relative shrink-0 text-[#e6e6e6] text-[16px] whitespace-nowrap">Firebase</p>
    </div>
  );
}
...
function TextContainer5() {
  return (
    <div className="bg-[#1f1f1f] content-stretch flex items-center px-[16px] py-[10px] relative rounded-[45px] shrink-0" data-name="Text Container">
      <p className="font-['Roboto_Mono:Regular',sans-serif] font-normal leading-[1.5] relative shrink-0 text-[#e6e6e6] text-[16px] whitespace-nowrap">Redux</p>
    </div>
  );
}
...
function TextContainer6() {
  return (
    <div className="bg-[#1f1f1f] content-stretch flex items-center px-[16px] py-[10px] relative rounded-[45px] shrink-0" data-name="Text Container">
      <p className="font-['Roboto_Mono:Regular',sans-serif] font-normal leading-[1.5] relative shrink-0 text-[#e6e6e6] text-[16px] whitespace-nowrap">REST API</p>
    </div>
  );
}
...
function TextContainer7() {
  return (
    <div className="bg-[#1f1f1f] content-stretch flex items-center px-[16px] py-[10px] relative rounded-[45px] shrink-0" data-name="Text Container">
      <p className="font-['Roboto_Mono:Regular',sans-serif] font-normal leading-[1.5] relative shrink-0 text-[#e6e6e6] text-[16px] whitespace-nowrap">MongoDB</p>
    </div>
  );
}
...
function SubContainer6() {
  return (
    <div className="content-start flex flex-wrap gap-[10px] items-start relative shrink-0 w-full" data-name="Sub Container">
      <TextContainer3 />
      <TextContainer4 />
      <TextContainer5 />
      <TextContainer6 />
...
function Container9() {
  return (
    <div className="bg-[#1a1a1a] relative rounded-[14px] shrink-0 w-full" data-name="Container">
      <div className="content-stretch flex flex-col gap-[20px] items-start p-[40px] relative w-full">
        <p className="font-['Roboto_Flex:Medium',sans-serif] font-medium leading-[1.5] not-italic relative shrink-0 text-[18px] text-white uppercase w-full" style={{ fontVariationSettings: "'GRAD' 0, 'XOPQ' 96, 'XTRA' 468, 'YOPQ' 79, 'YTAS' 750, 'YTDE' -203, 'YTFI' 738, 'YTLC' 514, 'YTUC' 712, 'wdth' 100" }}>
          Technologies Used
        </p>
        <SubContainer6 />
      </div>
...
function ImagesContainer() {
  return (
    <div className="content-start flex flex-[1_0_0] flex-wrap gap-[10px] items-start min-h-px min-w-px relative" data-name="Images Container">
      <div className="relative rounded-[100px] shrink-0 size-[50px]" data-name="Image">
        <div aria-hidden="true" className="absolute inset-0 pointer-events-none rounded-[100px]">
          <div className="absolute bg-[#e7beb1] inset-0 rounded-[100px]" />
      ...
      <div className="relative rounded-[100px] shrink-0 size-[50px]" data-name="Image">
        <div aria-hidden="true" className="absolute inset-0 pointer-events-none rounded-[100px]">
          <div className="absolute bg-[#e7beb1] inset-0 rounded-[100px]" />
          <img alt="" className="absolute max-w-none object-cover rounded-[100px] size-full" src={imgImage5} />
        </div>
      </div>
    </div>
  );
...
function Container10() {
  return (
    <div className="bg-[#1a1a1a] relative rounded-[14px] shrink-0 w-full" data-name="Container">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[40px] items-center px-[40px] py-[20px] relative w-full">
          <p className="font-['Roboto_Flex:Medium',sans-serif] font-medium leading-[1.5] not-italic relative shrink-0 text-[18px] text-white uppercase whitespace-nowrap" style={{ fontVariationSettings: "'GRAD' 0, 'XOPQ' 96, 'XTRA' 468, 'YOPQ' 79, 'YTAS' 750, 'YTDE' -203, 'YTFI' 738, 'YTLC' 514, 'YTUC' 712, 'wdth' 100" }}>
            Team Members
          </p>
          <ImagesContainer />
        </div>
...
function SubContainer5() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[20px] items-start min-h-px min-w-px relative" data-name="Sub Container">
      <Container9 />
      <Container10 />
      <Button18 />
    </div>
    ...
    <div className="relative rounded-[20px] shrink-0 w-full" data-name="Container">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex gap-[20px] items-start p-[20px] relative w-full">
          <Card />
          <div className="flex-[1_0_0] min-h-px min-w-px relative rounded-[14px] self-stretch" data-name="Image">
    ...
    <div className="relative shrink-0 size-[34px]" data-name="Bold / Essentional, UI / Balloon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 34 34">
        <g id="Bold / Essentional, UI / Balloon">
          <path clipRule="evenodd" d={svgPaths.p2f781600} fill="var(--fill-0, #CE7D63)" fillRule="evenodd" id="Vector" />
          <path d={svgPaths.p114fb500} fill="var(--fill-0, #CE7D63)" id="Vector_2" />
        </g>
      </svg>
    </div>
  );
...
function TextContainer8() {
  return (
    <div className="bg-[#1f1f1f] content-stretch flex gap-[8px] items-center px-[16px] py-[10px] relative rounded-[45px] shrink-0" data-name="Text Container">
      ...
      <p className="font-['Roboto_Flex:Medium',sans-serif] font-medium leading-[1.5] not-italic relative shrink-0 text-[#e6e6e6] text-[18px] whitespace-nowrap" style={{ fontVariationSettings: "'GRAD' 0, 'XOPQ' 96, 'XTRA' 468, 'YOPQ' 79, 'YTAS' 750, 'YTDE' -203, 'YTFI' 738, 'YTLC' 514, 'YTUC' 712, 'wdth' 100" }}>{`Web Design & Development`}</p>
    </div>
  );
}
...
function TextContainer10() {
  return (
    <div className="bg-[#1f1f1f] content-stretch flex items-center px-[16px] py-[10px] relative rounded-[45px] shrink-0" data-name="Text Container">
      <p className="font-['Roboto_Mono:Regular',sans-serif] font-normal leading-[1.5] relative shrink-0 text-[#e6e6e6] text-[16px] whitespace-nowrap">WordPress</p>
    </div>
  );
}
...
function TextContainer11() {
  return (
    <div className="bg-[#1f1f1f] content-stretch flex items-center px-[16px] py-[10px] relative rounded-[45px] shrink-0" data-name="Text Container">
      <p className="font-['Roboto_Mono:Regular',sans-serif] font-normal leading-[1.5] relative shrink-0 text-[#e6e6e6] text-[16px] whitespace-nowrap">PHP</p>
    </div>
  );
}
...
function TextContainer12() {
  return (
    <div className="bg-[#1f1f1f] content-stretch flex items-center px-[16px] py-[10px] relative rounded-[45px] shrink-0" data-name="Text Container">
      <p className="font-['Roboto_Mono:Regular',sans-serif] font-normal leading-[1.5] relative shrink-0 text-[#e6e6e6] text-[16px] whitespace-nowrap">HTML5</p>
    </div>
  );
}
...
function TextContainer13() {
  return (
    <div className="bg-[#1f1f1f] content-stretch flex items-center px-[16px] py-[10px] relative rounded-[45px] shrink-0" data-name="Text Container">
      <p className="font-['Roboto_Mono:Regular',sans-serif] font-normal leading-[1.5] relative shrink-0 text-[#e6e6e6] text-[16px] whitespace-nowrap">CSS3</p>
    </div>
  );
}
...
function TextContainer14() {
  return (
    <div className="bg-[#1f1f1f] content-stretch flex items-center px-[16px] py-[10px] relative rounded-[45px] shrink-0" data-name="Text Container">
      <p className="font-['Roboto_Mono:Regular',sans-serif] font-normal leading-[1.5] relative shrink-0 text-[#e6e6e6] text-[16px] whitespace-nowrap">JavaScript</p>
    </div>
  );
}
...
function ImagesContainer1() {
  return (
    <div className="content-start flex flex-[1_0_0] flex-wrap gap-[10px] items-start min-h-px min-w-px relative" data-name="Images Container">
      <div className="relative rounded-[100px] shrink-0 size-[50px]" data-name="Image">
        <div aria-hidden="true" className="absolute inset-0 pointer-events-none rounded-[100px]">
          <div className="absolute bg-[#e7beb1] inset-0 rounded-[100px]" />
          <img alt="" className="absolute max-w-none object-cover rounded-[100px] size-full" src={imgImage7} />
        </div>
      </div>
      <div className="relative rounded-[100px] shrink-0 size-[50px]" data-name="Image">
        <div aria-hidden="true" className="absolute inset-0 pointer-events-none rounded-[100px]">
      ...
      <div className="relative rounded-[100px] shrink-0 size-[50px]" data-name="Image">
        <div aria-hidden="true" className="absolute inset-0 pointer-events-none rounded-[100px]">
          <div className="absolute bg-[#e7beb1] inset-0 rounded-[100px]" />
          <img alt="" className="absolute max-w-none object-cover rounded-[100px] size-full" src={imgImage9} />
        </div>
      </div>
      <div className="relative rounded-[100px] shrink-0 size-[50px]" data-name="Image">
        <div aria-hidden="true" className="absolute inset-0 pointer-events-none rounded-[100px]">
          <div className="absolute bg-[#e7beb1] inset-0 rounded-[100px]" />
          <img alt="" className="absolute max-w-none object-cover rounded-[100px] size-full" src={imgImage10} />
        </div>
      </div>
      <div className="relative rounded-[100px] shrink-0 size-[50px]" data-name="Image">
        <div aria-hidden="true" className="absolute inset-0 pointer-events-none rounded-[100px]">
        ...
        <div className="content-stretch flex gap-[20px] items-start p-[20px] relative w-full">
          ...
          <div className="flex-[1_0_0] min-h-px min-w-px relative rounded-[14px] self-stretch" data-name="Image">
            <div aria-hidden="true" className="absolute inset-0 pointer-events-none rounded-[14px]">
              ...
              <img alt="" className="absolute max-w-none object-cover rounded-[14px] size-full" src={imgImage6} />
            </div>
          </div>
          <SubContainer9 />
        </div>
...
function Container5() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[20px] items-start left-[50px] top-[1648px] w-[1818px]" data-name="Container">
      <SubContainer1 />
      <SubContainer2 />
    </div>
  );
  ...
  return (
    <div className="bg-[#1a1a1a] relative rounded-[16px] shrink-0 w-full" data-name="Sub Container">
      <div className="content-stretch flex items-start justify-between p-[50px] relative w-full">
        <p className="font-['Roboto_Mono:Regular',sans-serif] font-normal leading-[1.5] relative shrink-0 text-[#b3b3b2] text-[18px] whitespace-nowrap">© 2024 Telente Technologies. All rights reserved.</p>
        <Container31 />
      </div>
    </div>
  );
...
function SubContainer22() {
  return (
    <div className="content-stretch flex gap-[30px] items-center relative shrink-0 w-full" data-name="Sub Container">
    ...
    <div className="relative shrink-0 w-full" data-name="Text Container">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex items-center justify-center pr-[120px] relative w-full">
          <p className="flex-[1_0_0] font-['Roboto_Flex:Regular',sans-serif] font-normal leading-[1.5] min-h-px min-w-px not-italic relative text-[#676665] text-[18px]" style={{ fontVariationSettings: "'GRAD' 0, 'XOPQ' 96, 'XTRA' 468, 'YOPQ' 79, 'YTAS' 750, 'YTDE' -203, 'YTFI' 738, 'YTLC' 514, 'YTUC' 712, 'wdth' 100" }}>
            At NexGen, we are committed to empowering your digital vision with innovative solutions tailored to your unique needs. Our team of skilled professionals, coupled with cutting-edge technologies, ensures that we deliver exceptional results that elevate your online presence.
          </p>
        </div>
      </div>
    </div>
...
function SubContainer21() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[20px] items-center justify-center min-h-px min-w-px relative" data-name="Sub Container">
      <Container33 />
      <TextContainer22 />
    </div>
  );
...
function TextContainer23() {
  return (
    <div className="backdrop-blur-[10px] bg-[rgba(255,255,255,0.2)] content-stretch flex items-center justify-center px-[14px] py-[10px] relative rounded-[10px] shrink-0" data-name="Text Container">
      <p className="font-['Roboto_Flex:Regular',sans-serif] font-normal leading-[1.5] not-italic relative shrink-0 text-[16px] text-white uppercase whitespace-nowrap" style={{ fontVariationSettings: "'GRAD' 0, 'XOPQ' 96, 'XTRA' 468, 'YOPQ' 79, 'YTAS' 750, 'YTDE' -203, 'YTFI' 738, 'YTLC' 514, 'YTUC' 712, 'wdth' 100" }}>{`Web Development. `}</p>
    </div>
  );
}
...
function Icon19() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="Icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="Icon">
          <path clipRule="evenodd" d={svgPaths.pae702c0} fill="var(--fill-0, #0F0F0F)" fillRule="evenodd" id="Vector 431 (Stroke)" />
        </g>
      </svg>
    </div>
  );
...
function Button28() {
  return (
    <div className="bg-white content-stretch flex items-start p-[10px] relative rounded-[100px] shrink-0" data-name="Button">
      <Icon19 />
    </div>
  );
}
...
function Container34() {
  return (
    <div className="content-stretch flex gap-[10px] items-center relative shrink-0" data-name="Container">
      <Button28 />
      <p className="font-['Roboto_Mono:Regular',sans-serif] font-normal leading-[1.5] relative shrink-0 text-[18px] text-white uppercase whitespace-nowrap">View Blog</p>
    </div>
  );
}
...
function Card6() {
  return (
    <div className="content-stretch flex h-[537px] items-end justify-between p-[30px] relative rounded-[20px] shrink-0 w-[593px]" data-name="Card">
      <div aria-hidden="true" className="absolute inset-0 pointer-events-none rounded-[20px]">
        <img alt="" className="absolute max-w-none object-cover rounded-[20px] size-full" src={imgCard} />
        <div className="absolute bg-[rgba(206,125,99,0.8)] inset-0 mix-blend-color rounded-[20px]" />
      </div>
      <TextContainer23 />
      <Container34 />
    </div>
...
function Container32() {
  return (
    <div className="absolute bg-[#1a1a1a] content-stretch flex gap-[80px] items-center justify-center left-[50px] overflow-clip pl-[80px] pr-[50px] py-[50px] rounded-[20px] top-[191px] w-[1820px]" data-name="Container">
      <SubContainer21 />
      <Card6 />
    </div>
  );
    ...
    <div className="content-stretch flex flex-[1_0_0] gap-[15px] items-center min-h-px min-w-px relative" data-name="Sub Container">
      <div className="relative rounded-[100px] shrink-0 size-[60px]" data-name="Image">
        <div aria-hidden="true" className="absolute inset-0 pointer-events-none rounded-[100px]">
          ...
          <img alt="" className="absolute max-w-none object-cover rounded-[100px] size-full" src={imgImage11} />
        </div>
      </div>
      <TextContainer24 />
    </div>
  ...
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[15px] items-center min-h-px min-w-px relative" data-name="Sub Container">
      <div className="relative rounded-[100px] shrink-0 size-[60px]" data-name="Image">
        <div aria-hidden="true" className="absolute inset-0 pointer-events-none rounded-[100px]">
          <div className="absolute bg-[#ce7d63] inset-0 rounded-[100px]" />
          <img alt="" className="absolute max-w-none object-cover rounded-[100px] size-full" src={imgImage12} />
        </div>
      </div>
      <TextContainer25 />
    </div>
  ...
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[15px] items-center min-h-px min-w-px relative" data-name="Sub Container">
      <div className="relative rounded-[100px] shrink-0 size-[60px]" data-name="Image">
        <div aria-hidden="true" className="absolute inset-0 pointer-events-none rounded-[100px]">
          <div className="absolute bg-[#ce7d63] inset-0 rounded-[100px]" />
          <img alt="" className="absolute max-w-none object-cover rounded-[100px] size-full" src={imgImage13} />
        </div>
      </div>
      <TextContainer26 />
    </div>
    ...
    <div className="content-stretch flex flex-[1_0_0] gap-[15px] items-center min-h-px min-w-px relative" data-name="Sub Container">
      <div className="relative rounded-[100px] shrink-0 size-[60px]" data-name="Image">
        <div aria-hidden="true" className="absolute inset-0 pointer-events-none rounded-[100px]">
          <div className="absolute bg-[#ce7d63] inset-0 rounded-[100px]" />
          <img alt="" className="absolute max-w-none object-cover rounded-[100px] size-full" src={imgImage11} />
          <img alt="" className="absolute max-w-none object-cover rounded-[100px] size-full" src={imgImage14} />
        </div>
      </div>
      <TextContainer27 />
    </div>
...
function Container35() {
  return (
    <div className="absolute bottom-[2515px] content-stretch flex flex-col gap-[20px] items-start left-[50px] p-[20px] rounded-[24px] w-[1820px]" data-name="Container">
...
function BoldDesignToolsRulerPen() {
  return (
    <div className="relative shrink-0 size-[34px]" data-name="Bold / Design, Tools / Ruler Pen">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 34 34">
        <g id="Bold / Design, Tools / Ruler Pen">
          <path d={svgPaths.p3daa4800} fill="var(--fill-0, #CE7D63)" id="Vector" />
          <g id="Vector_2">
            <path d={svgPaths.p2654b700} fill="var(--fill-0, #CE7D63)" />
            <path d={svgPaths.pc7b8b80} fill="var(--fill-0, #CE7D63)" />
          </g>
        </g>
      </svg>
    </div>
...
function TextContainer29() {
  return (
    <div className="content-stretch flex flex-col gap-[12px] items-start leading-[1.5] not-italic relative shrink-0 w-full" data-name="Text Container">
      ...
      <p className="font-['Roboto_Flex:Regular',sans-serif] font-normal relative shrink-0 text-[#b3b3b2] text-[18px] w-full" style={{ fontVariationSettings: "'GRAD' 0, 'XOPQ' 96, 'XTRA' 468, 'YOPQ' 79, 'YTAS' 750, 'YTDE' -203, 'YTFI' 738, 'YTLC' 514, 'YTUC' 712, 'wdth' 100" }}>{`Every project begins with thorough research and strategic planning to ensure a holistic understanding of our clients' objectives.`}</p>
    </div>
  );
}
...
function BoldLikeStar() {
  return (
    <div className="relative shrink-0 size-[34px]" data-name="Bold / Like / Star">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 34 34">
        <g id="Bold / Like / Star">
          <path d={svgPaths.p3bb15e80} fill="var(--fill-0, #CE7D63)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function TextContainer30() {
  return (
    <div className="content-stretch flex flex-col gap-[12px] items-start leading-[1.5] not-italic relative shrink-0 w-full" data-name="Text Container">
      ...
      <p className="font-['Roboto_Flex:Regular',sans-serif] font-normal relative shrink-0 text-[#b3b3b2] text-[18px] w-full" style={{ fontVariationSettings: "'GRAD' 0, 'XOPQ' 96, 'XTRA' 468, 'YOPQ' 79, 'YTAS' 750, 'YTDE' -203, 'YTFI' 738, 'YTLC' 514, 'YTUC' 712, 'wdth' 100" }}>{`We believe in tailoring our services to suit each project's unique requirements, resulting in solutions.`}</p>
    </div>
  );
}
...
function BoldSecurityShieldUser() {
  return (
    <div className="relative shrink-0 size-[34px]" data-name="Bold / Security / Shield User">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 34 34">
        <g id="Bold / Security / Shield User">
          <path clipRule="evenodd" d={svgPaths.p12f08100} fill="var(--fill-0, #CE7D63)" fillRule="evenodd" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function BoldTimeStopwatch() {
  return (
    <div className="relative shrink-0 size-[34px]" data-name="Bold / Time / Stopwatch">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 34 34">
        <g id="Bold / Time / Stopwatch">
          <g id="Vector">
            <path clipRule="evenodd" d={svgPaths.p2fdb1b80} fill="var(--fill-0, #CE7D63)" fillRule="evenodd" />
            <path clipRule="evenodd" d={svgPaths.p27d94600} fill="var(--fill-0, #CE7D63)" fillRule="evenodd" />
          </g>
        </g>
      </svg>
    </div>
...
function Container45() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[20px] items-start left-[50px] p-[20px] rounded-[24px] top-[948px] w-[1820px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-2 border-[#1f1f1f] border-solid inset-0 pointer-events-none rounded-[24px]" />
      <TextContainer28 />
      <ItemsContainer2 />
    </div>
...
export default function ProjectsPageDesktop() {
  return (
    <div className="bg-[#0f0f0f] relative size-full" data-name="Projects Page - Desktop">
      <Navbar />
      <Container />
      <Container5 />
      <Container16 />
