import svgPaths from "./svg-o2qg4vmwj9";
...
import imgImage4 from "figma:asset/8410421760a1d164d08527cf8780ec84c55aa884.png";
import imgImage5 from "figma:asset/41fb78f8a521924f84835648bca5f97d31f489e7.png";
import imgImage6 from "figma:asset/ffd5dce97199b86773a68b59a42d1cfa66e5b456.png";
import imgImage7 from "figma:asset/1708d5ebaf4e0ae55b89b5d6fb1b720dffc07c0b.png";
import imgImage8 from "figma:asset/75cb4a1f7ed7a4cb212ecc32abf92f50404afbb8.png";
import imgImage9 from "figma:asset/136f2a79970377b23d2ef59405879b8f051e3ece.png";
import imgImage10 from "figma:asset/9333dbfd96156981d7444169ea92aa972ca6be65.png";
import imgImage11 from "figma:asset/5cbce443146b069825c04a4d6865200088d3b3f3.png";
import imgImage12 from "figma:asset/50c28168a048d9c7c78df941674e8eee6424fd2f.png";
import imgImage13 from "figma:asset/f4559868741232445220d231eca9a5fd1400bd2c.png";
import imgImage14 from "figma:asset/b78b1abab5fbd8644d7928a37d8134c3e5f10dc1.png";
import imgImage15 from "figma:asset/de171dee2966eecc8da6ffdd1a37b682b3bb34ff.png";
...
function Button() {
  return (
    <div className="bg-[#0f0f0f] content-stretch flex items-center px-[24px] py-[18px] relative rounded-[12px] shrink-0" data-name="Button">
      <p className="font-['Roboto_Mono:Medium',sans-serif] font-medium leading-[1.5] relative shrink-0 text-[#e7beb1] text-[18px] text-center uppercase whitespace-nowrap">Home</p>
    </div>
  );
}
...
function Container1() {
  return (
    <div className="content-stretch flex gap-[10px] items-center relative shrink-0 w-full" data-name="Container">
      <Button7 />
      <p className="flex-[1_0_0] font-['Roboto_Flex:Regular',sans-serif] font-normal leading-[1.5] min-h-px min-w-px not-italic relative text-[#b3b3b2] text-[18px]" style={{ fontVariationSettings: "'GRAD' 0, 'XOPQ' 96, 'XTRA' 468, 'YOPQ' 79, 'YTAS' 750, 'YTDE' -203, 'YTFI' 738, 'YTLC' 514, 'YTUC' 712, 'wdth' 100" }}>
        Learn More
      </p>
    </div>
  );
...
function Container() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[20px] items-start left-[50px] p-[20px] rounded-[24px] top-[1083px] w-[1820px]" data-name="Container">
    ...
    <div className="relative shrink-0 size-[34px]" data-name="Bold / Design, Tools / Ruler Cross Pen">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 34 34">
        <g id="Bold / Design, Tools / Ruler Cross Pen">
          <g id="Vector">
            <path d={svgPaths.p3527ecf0} fill="var(--fill-0, #CE7D63)" />
            <path d={svgPaths.p123c4000} fill="var(--fill-0, #CE7D63)" />
          </g>
          <g id="Vector_2">
            <path d={svgPaths.p2670a00} fill="var(--fill-0, #CE7D63)" />
            <path d={svgPaths.p3a5f3e00} fill="var(--fill-0, #CE7D63)" />
          </g>
        </g>
      </svg>
    </div>
...
function SubContainer6() {
  return (
    <div className="content-stretch flex gap-[10px] items-center relative shrink-0" data-name="Sub Container">
      <Button16 />
      <p className="font-['Roboto_Mono:Medium',sans-serif] font-medium leading-[1.5] relative shrink-0 text-[#b3b3b2] text-[20px] uppercase whitespace-nowrap">Book A Call</p>
    </div>
  );
}
    ...
    <div className="relative shrink-0 size-[34px]" data-name="Bold / Electronic, Devices / Smartphone 2">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 34 34">
        <g id="Bold / Electronic, Devices / Smartphone 2">
          <path clipRule="evenodd" d={svgPaths.p3d2b8100} fill="var(--fill-0, #CE7D63)" fillRule="evenodd" id="Vector" />
        </g>
      </svg>
    </div>
  );
    ...
    <div className="relative shrink-0 size-[34px]" data-name="Bold / Network, IT, Programming / Code Circle">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 34 34">
        <g id="Bold / Network, IT, Programming / Code Circle">
          <path clipRule="evenodd" d={svgPaths.p2e34ee70} fill="var(--fill-0, #CE7D63)" fillRule="evenodd" id="Vector" />
        </g>
      </svg>
    </div>
  );
    ...
    <div className="relative shrink-0 size-[34px]" data-name="Bold / Settings, Fine Tuning / Widget 6">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 34 34">
        <g id="Bold / Settings, Fine Tuning / Widget 6">
          <g id="Vector">
            <path d={svgPaths.p70aa500} fill="var(--fill-0, #CE7D63)" />
            <path d={svgPaths.p319d5c00} fill="var(--fill-0, #CE7D63)" />
            <path d={svgPaths.p176d4100} fill="var(--fill-0, #CE7D63)" />
            <path d={svgPaths.pfc7fe00} fill="var(--fill-0, #CE7D63)" />
          </g>
        </g>
      </svg>
    </div>
...
function Container15() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[20px] items-start left-[50px] p-[20px] rounded-[24px] top-[1817px] w-[1820px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-2 border-[#1f1f1f] border-solid inset-0 pointer-events-none rounded-[24px]" />
      <TextContainer9 />
      <ItemsContainer2 />
      <ItemsContainer3 />
...
function Container21() {
  return (
    <div className="content-stretch flex gap-[10px] items-center relative shrink-0" data-name="Container">
      <Button20 />
      <p className="font-['Roboto_Mono:Medium',sans-serif] font-medium leading-[1.5] relative shrink-0 text-[#b3b3b2] text-[20px] uppercase whitespace-nowrap">ALL Works</p>
    </div>
  );
}
  ...
  return (
    <div className="content-start flex flex-[1_0_0] flex-wrap gap-[10px] items-start min-h-px min-w-px relative" data-name="Images Container">
      ...
      <div className="relative rounded-[100px] shrink-0 size-[50px]" data-name="Image">
        <div aria-hidden="true" className="absolute inset-0 pointer-events-none rounded-[100px]">
          <div className="absolute bg-[#e7beb1] inset-0 rounded-[100px]" />
          <img alt="" className="absolute max-w-none object-cover rounded-[100px] size-full" src={imgImage6} />
        </div>
      </div>
      <div className="relative rounded-[100px] shrink-0 size-[50px]" data-name="Image">
        <div aria-hidden="true" className="absolute inset-0 pointer-events-none rounded-[100px]">
        ...
        <div className="content-stretch flex gap-[20px] items-start p-[20px] relative w-full">
          ...
          <div className="flex-[1_0_0] min-h-px min-w-px relative rounded-[14px] self-stretch" data-name="Image">
            <div aria-hidden="true" className="absolute inset-0 pointer-events-none rounded-[14px]">
              ...
              <img alt="" className="absolute max-w-none object-cover rounded-[14px] size-full" src={imgImage10} />
            </div>
          </div>
          <SubContainer21 />
        </div>
...
function Container20() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[20px] items-start left-[50px] top-[2963px] w-[1818px]" data-name="Container">
      <SubContainer13 />
      <SubContainer14 />
    </div>
  );
...
function Container57() {
  return (
    <div className="content-stretch flex gap-[20px] items-center relative shrink-0" data-name="Container">
      ...
      <p className="font-['Roboto_Mono:Regular',sans-serif] font-normal leading-[1.5] relative shrink-0 text-[#676665] text-[20px] uppercase whitespace-nowrap">Website Design</p>
      <div className="relative shrink-0 size-[7px]" data-name="Shape">
        <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 7 7">
          <circle cx="3.5" cy="3.5" fill="var(--fill-0, #CE7D63)" id="Shape" r="3.5" />
        </svg>
      </div>
      <p className="font-['Roboto_Mono:Regular',sans-serif] font-normal leading-[1.5] relative shrink-0 text-[#676665] text-[20px] uppercase whitespace-nowrap">Branding</p>
      <div className="relative shrink-0 size-[7px]" data-name="Shape">
        <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 7 7">
          <circle cx="3.5" cy="3.5" fill="var(--fill-0, #CE7D63)" id="Shape" r="3.5" />
        </svg>
      </div>
      <p className="font-['Roboto_Mono:Regular',sans-serif] font-normal leading-[1.5] relative shrink-0 text-[#676665] text-[20px] uppercase whitespace-nowrap">Website Development</p>
      <div className="relative shrink-0 size-[7px]" data-name="Shape">
        <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 7 7">
          <circle cx="3.5" cy="3.5" fill="var(--fill-0, #CE7D63)" id="Shape" r="3.5" />
        </svg>
      </div>
      <p className="font-['Roboto_Mono:Regular',sans-serif] font-normal leading-[1.5] relative shrink-0 text-[#676665] text-[20px] uppercase whitespace-nowrap">Mobile App Development</p>
      <div className="relative shrink-0 size-[7px]" data-name="Shape">
        <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 7 7">
          <circle cx="3.5" cy="3.5" fill="var(--fill-0, #CE7D63)" id="Shape" r="3.5" />
        </svg>
...
function Container54() {
  return (
    <div className="bg-[#1a1a1a] flex-[1_0_0] min-h-px min-w-px relative rounded-[20px]" data-name="Container">
      <div className="flex flex-col items-center justify-center overflow-clip rounded-[inherit] size-full">
  ...
  return (
    <div className="bg-[#1f1f1f] relative shrink-0 w-full" data-name="Text Container">
      <div className="content-stretch flex flex-col gap-[4px] items-start leading-[1.5] not-italic p-[30px] relative w-full">
        ...
        <p className="font-['Roboto_Flex:Regular',sans-serif] font-normal relative shrink-0 text-[#b3b3b2] text-[18px] w-full" style={{ fontVariationSettings: "'GRAD' 0, 'XOPQ' 96, 'XTRA' 468, 'YOPQ' 79, 'YTAS' 750, 'YTDE' -203, 'YTFI' 738, 'YTLC' 514, 'YTUC' 712, 'wdth' 100" }}>{`Web Development. `}</p>
      </div>
    </div>
  );
}
    ...
    <div className="absolute right-[13px] size-[88px] top-[31px]" data-name="Button">
      <div className="absolute inset-[-17.52%_0_-34.09%_-34.09%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 118 133.42">
          <g id="Button">
            <rect fill="var(--fill-0, #CE7D63)" height="88" rx="44" width="88" x="30.0002" y="15.4194" />
            <g id="Icon">
              <path clipRule="evenodd" d={svgPaths.p1f7a9500} fill="var(--fill-0, #0F0F0F)" fillRule="evenodd" id="Vector 431 (Stroke)" />
            </g>
            <path d={svgPaths.p23a27600} fill="var(--fill-0, #CE7D63)" id="Shape" />
          </g>
        </svg>
      </div>
    </div>
  ...
  return (
    <div className="content-stretch flex flex-col items-start overflow-clip relative rounded-[14px] shrink-0 w-[593px]" data-name="Container">
      <div className="h-[465px] relative shrink-0 w-full" data-name="Image">
        <img alt="" className="absolute block max-w-none size-full" height="465" src={imgImage15} width="593" />
      </div>
      <TextContainer36 />
      <Button39 />
    </div>
...
function TextContainer37() {
  return (
    <div className="bg-[#1a1a1a] flex-[1_0_0] min-h-px min-w-px relative rounded-[14px]" data-name="Text Container">
      <div className="content-stretch flex flex-col gap-[20px] items-start leading-[1.5] px-[20px] py-[30px] relative text-center uppercase w-full">
        ...
        <p className="font-['Roboto_Flex:SemiBold',sans-serif] font-semibold not-italic relative shrink-0 text-[#da9e8b] text-[60px] w-full" style={{ fontVariationSettings: "'GRAD' 0, 'XOPQ' 96, 'XTRA' 468, 'YOPQ' 79, 'YTAS' 750, 'YTDE' -203, 'YTFI' 738, 'YTLC' 514, 'YTUC' 712, 'wdth' 100" }}>
          200+
        </p>
      </div>
    </div>
  ...
  return (
    <div className="bg-[#1a1a1a] flex-[1_0_0] min-h-px min-w-px relative rounded-[14px]" data-name="Text Container">
      <div className="content-stretch flex flex-col gap-[20px] items-start leading-[1.5] px-[20px] py-[30px] relative text-center w-full">
        ...
        <p className="font-['Roboto_Flex:SemiBold',sans-serif] font-semibold not-italic relative shrink-0 text-[#da9e8b] text-[60px] uppercase w-full" style={{ fontVariationSettings: "'GRAD' 0, 'XOPQ' 96, 'XTRA' 468, 'YOPQ' 79, 'YTAS' 750, 'YTDE' -203, 'YTFI' 738, 'YTLC' 514, 'YTUC' 712, 'wdth' 100" }}>
          280+
        </p>
      </div>
    </div>
...
function TextContainer40() {
  return (
    <div className="bg-[#1a1a1a] flex-[1_0_0] min-h-px min-w-px relative rounded-[14px]" data-name="Text Container">
      <div className="content-stretch flex flex-col gap-[20px] items-start leading-[1.5] px-[20px] py-[30px] relative text-center w-full">
        <p className="font-['Roboto_Mono:Medium',sans-serif] font-medium relative shrink-0 text-[#b3b3b2] text-[18px] w-full">FOLLOWER</p>
        <p className="font-['Roboto_Flex:SemiBold',sans-serif] font-semibold not-italic relative shrink-0 text-[#da9e8b] text-[60px] uppercase w-full" style={{ fontVariationSettings: "'GRAD' 0, 'XOPQ' 96, 'XTRA' 468, 'YOPQ' 79, 'YTAS' 750, 'YTDE' -203, 'YTFI' 738, 'YTLC' 514, 'YTUC' 712, 'wdth' 100" }}>
          420K
        </p>
      </div>
...
function TextContainer41() {
  return (
    <div className="bg-[#1a1a1a] flex-[1_0_0] min-h-px min-w-px relative rounded-[14px]" data-name="Text Container">
      <div className="content-stretch flex flex-col gap-[20px] items-start leading-[1.5] px-[20px] py-[30px] relative text-center w-full">
        <p className="font-['Roboto_Mono:Medium',sans-serif] font-medium relative shrink-0 text-[#b3b3b2] text-[18px] w-full">Years Of Experience</p>
        <p className="font-['Roboto_Flex:SemiBold',sans-serif] font-semibold not-italic relative shrink-0 text-[#da9e8b] text-[60px] uppercase w-full" style={{ fontVariationSettings: "'GRAD' 0, 'XOPQ' 96, 'XTRA' 468, 'YOPQ' 79, 'YTAS' 750, 'YTDE' -203, 'YTFI' 738, 'YTLC' 514, 'YTUC' 712, 'wdth' 100" }}>
          10+
        </p>
      </div>
...
function Button40() {
  return (
    <div className="bg-[#1a1a1a] flex-[1_0_0] h-full min-h-px min-w-px relative rounded-[14px]" data-name="Button">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex gap-[10px] items-center justify-center px-[20px] py-[30px] relative size-full">
          <IconContainer10 />
          <p className="font-['Roboto_Mono:Medium',sans-serif] font-medium leading-[1.5] relative shrink-0 text-[#b3b3b2] text-[20px] uppercase whitespace-nowrap">Know More</p>
        </div>
      </div>
    </div>
  );
...
function Container53() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[20px] items-start left-[50px] top-[161px] w-[1820px]" data-name="Container">
      <SubContainer34 />
      <SubContainer37 />
    </div>
  );
...
export default function HomePageDesktop() {
  return (
    <div className="bg-[#0f0f0f] relative size-full" data-name="Home Page - Desktop">
      <Navbar />
      <Container />
      <Container5 />
      <Container15 />
