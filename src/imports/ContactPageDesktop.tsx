import svgPaths from "./svg-socp6v2aou";
...
import imgImage4 from "figma:asset/45905ff594ea81e4c2c6c594416c7c84aaa8808a.png";
...
function TextContainer13() {
  return (
    <div className="bg-[#1f1f1f] flex-[1_0_0] min-h-px min-w-px relative rounded-[14px]" data-name="Text Container">
      <div className="content-stretch flex flex-col gap-[20px] items-start leading-[1.5] px-[20px] py-[42px] relative text-center uppercase w-full">
...
function TextContainer14() {
  return (
    <div className="bg-[#1f1f1f] flex-[1_0_0] min-h-px min-w-px relative rounded-[14px]" data-name="Text Container">
      <div className="content-stretch flex flex-col gap-[20px] items-start leading-[1.5] px-[20px] py-[42px] relative text-center w-full">
...
function Icon22() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="Icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="Icon">
          <path d={svgPaths.p28c91700} id="Vector" stroke="var(--stroke-0, #E7BEB1)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
        </g>
      </svg>
    </div>
  );
...
function IconContainer4() {
  return (
    <div className="bg-[#1f1f1f] content-stretch flex items-start p-[14px] relative rounded-[100px] shrink-0" data-name="Icon Container">
      <div aria-hidden="true" className="absolute border border-[#333] border-solid inset-0 pointer-events-none rounded-[100px]" />
      <Icon22 />
    </div>
  );
...
function Button26() {
  return (
    <div className="bg-[#1f1f1f] flex-[1_0_0] h-full min-h-px min-w-px relative rounded-[14px]" data-name="Button">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex gap-[10px] items-center justify-center px-[20px] py-[42px] relative size-full">
          <IconContainer4 />
          <p className="font-['Roboto_Mono:Medium',sans-serif] font-medium leading-[1.5] relative shrink-0 text-[#b3b3b2] text-[20px] uppercase whitespace-nowrap">Reach Us</p>
        </div>
      </div>
    </div>
  );
...
function Button27() {
  return (
    <div className="bg-[#1f1f1f] flex-[1_0_0] min-h-px min-w-px relative rounded-[12px]" data-name="Button">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex items-center justify-center px-[24px] py-[18px] relative w-full">
...
function Button28() {
  return (
    <div className="bg-[#ce7d63] flex-[1_0_0] min-h-px min-w-px relative rounded-[12px]" data-name="Button">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex items-center justify-center px-[24px] py-[18px] relative w-full">
          <p className="font-['Roboto_Flex:Medium',sans-serif] font-medium leading-[1.5] not-italic relative shrink-0 text-[#0f0f0f] text-[18px] text-center uppercase whitespace-nowrap" style={{ fontVariationSettings: "'GRAD' 0, 'XOPQ' 96, 'XTRA' 468, 'YOPQ' 79, 'YTAS' 750, 'YTDE' -203, 'YTFI' 738, 'YTLC' 514, 'YTUC' 712, 'wdth' 100" }}>
            Emails
...
function TabsContainer() {
  return (
    <div className="content-stretch flex gap-[12px] items-start relative shrink-0 w-full" data-name="Tabs Container">
      <Button27 />
      <Button28 />
      <Button29 />
    </div>
...
function Container39() {
  return (
    <div className="bg-[#1f1f1f] relative rounded-bl-[14px] rounded-br-[100px] rounded-tl-[14px] rounded-tr-[100px] shrink-0 w-full" data-name="Container">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[10px] items-center pl-[24px] pr-[14px] py-[10px] relative w-full">
          <p className="flex-[1_0_0] font-['Roboto_Mono:Medium',sans-serif] font-medium leading-[1.5] min-h-px min-w-px relative text-[18px] text-white uppercase">info@NexGen.com</p>
          <Button30 />
        </div>
      </div>
    </div>
...
function SubContainer21() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 w-full" data-name="Sub Container">
      <p className="font-['Roboto_Flex:Regular',sans-serif] font-normal leading-[1.5] not-italic relative shrink-0 text-[#81807e] text-[20px] w-full" style={{ fontVariationSettings: "'GRAD' 0, 'XOPQ' 96, 'XTRA' 468, 'YOPQ' 79, 'YTAS' 750, 'YTDE' -203, 'YTFI' 738, 'YTLC' 514, 'YTUC' 712, 'wdth' 100" }}>
        General Inquiries
      </p>
      <Container39 />
    </div>
...
function Container40() {
  return (
    <div className="bg-[#1f1f1f] relative rounded-bl-[14px] rounded-br-[100px] rounded-tl-[14px] rounded-tr-[100px] shrink-0 w-full" data-name="Container">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[10px] items-center pl-[24px] pr-[14px] py-[10px] relative w-full">
          <p className="flex-[1_0_0] font-['Roboto_Mono:Medium',sans-serif] font-medium leading-[1.5] min-h-px min-w-px relative text-[18px] text-white uppercase">partnerships@NexGen.com</p>
          <Button31 />
        </div>
      </div>
    </div>
...
function Container41() {
  return (
    <div className="bg-[#1f1f1f] relative rounded-bl-[14px] rounded-br-[100px] rounded-tl-[14px] rounded-tr-[100px] shrink-0 w-full" data-name="Container">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[10px] items-center pl-[24px] pr-[14px] py-[10px] relative w-full">
          <p className="flex-[1_0_0] font-['Roboto_Mono:Medium',sans-serif] font-medium leading-[1.5] min-h-px min-w-px relative text-[18px] text-white uppercase">careers@NexGen.com</p>
          <Button32 />
        </div>
      </div>
    </div>
...
function SubContainer20() {
  return (
    <div className="bg-[#1a1a1a] content-stretch flex flex-col gap-[80px] items-start p-[50px] relative rounded-[14px] shrink-0 w-[747px]" data-name="Sub Container">
      <TabsContainer />
      <Container38 />
    </div>
  );
...
function InputField4() {
  return (
    <div className="bg-[#1f1f1f] relative rounded-[12px] shrink-0 w-full" data-name="Input Field">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex items-center p-[20px] relative w-full">
          <p className="flex-[1_0_0] font-['Roboto_Flex:Regular',sans-serif] font-normal leading-[1.5] min-h-px min-w-px not-italic relative text-[#81807e] text-[18px]" style={{ fontVariationSettings: "'GRAD' 0, 'XOPQ' 96, 'XTRA' 468, 'YOPQ' 79, 'YTAS' 750, 'YTDE' -203, 'YTFI' 738, 'YTLC' 514, 'YTUC' 712, 'wdth' 100" }}>
            Enter First Name
          </p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border border-[#333] border-solid inset-0 pointer-events-none rounded-[12px] shadow-[0px_0px_0px_4px_#242424]" />
    </div>
  );
}
...
function Container42() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[16px] items-start min-h-px min-w-px relative" data-name="Container">
      <p className="font-['Roboto_Mono:Medium',sans-serif] font-medium leading-[1.5] relative shrink-0 text-[#f3dfd8] text-[18px] uppercase w-full">First Name</p>
      <InputField4 />
    </div>
  );
}
...
function InputFeild() {
  return (
    <div className="bg-[#1f1f1f] relative rounded-[12px] shrink-0 w-full" data-name="Input Feild">
      <div aria-hidden="true" className="absolute border border-[#333] border-solid inset-0 pointer-events-none rounded-[12px]" />
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center p-[20px] relative w-full">
          <p className="flex-[1_0_0] font-['Roboto_Flex:Regular',sans-serif] font-normal leading-[1.5] min-h-px min-w-px not-italic relative text-[#81807e] text-[18px]" style={{ fontVariationSettings: "'GRAD' 0, 'XOPQ' 96, 'XTRA' 468, 'YOPQ' 79, 'YTAS' 750, 'YTDE' -203, 'YTFI' 738, 'YTLC' 514, 'YTUC' 712, 'wdth' 100" }}>
...
function Container43() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[16px] items-start min-h-px min-w-px relative" data-name="Container">
      <p className="font-['Roboto_Mono:Medium',sans-serif] font-medium leading-[1.5] relative shrink-0 text-[#f3dfd8] text-[18px] uppercase w-full">Last Name</p>
      <InputFeild />
    </div>
  );
}
...
function ItemsContainer2() {
  return (
    <div className="content-stretch flex gap-[50px] items-start relative shrink-0 w-full" data-name="Items Container">
      <Container42 />
      <Container43 />
    </div>
  );
...
function Container44() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[16px] items-start min-h-px min-w-px relative" data-name="Container">
      <p className="font-['Roboto_Mono:Medium',sans-serif] font-medium leading-[1.5] relative shrink-0 text-[#f3dfd8] text-[18px] uppercase w-full">Email</p>
      <InputField5 />
    </div>
  );
}
...
function Container46() {
  return (
    <div className="content-stretch flex gap-[6px] items-center relative shrink-0" data-name="Container">
      <div className="relative rounded-[11px] shrink-0 size-[50px]" data-name="Image">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-[11px] size-full" src={imgImage4} />
      </div>
      <Icon26 />
    </div>
  );
...
function InputField6() {
  return (
    <div className="bg-[#1f1f1f] flex-[1_0_0] min-h-px min-w-px relative rounded-[12px]" data-name="Input Field">
      <div aria-hidden="true" className="absolute border border-[#333] border-solid inset-0 pointer-events-none rounded-[12px]" />
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center p-[20px] relative w-full">
          <p className="flex-[1_0_0] font-['Roboto_Flex:Regular',sans-serif] font-normal leading-[1.5] min-h-px min-w-px not-italic relative text-[#81807e] text-[18px]" style={{ fontVariationSettings: "'GRAD' 0, 'XOPQ' 96, 'XTRA' 468, 'YOPQ' 79, 'YTAS' 750, 'YTDE' -203, 'YTFI' 738, 'YTLC' 514, 'YTUC' 712, 'wdth' 100" }}>
...
function InputFeild1() {
  return (
    <div className="content-stretch flex gap-[16px] items-center relative shrink-0 w-full" data-name="Input Feild">
      <Container46 />
      <InputField6 />
    </div>
  );
...
function Container45() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[16px] items-start min-h-px min-w-px relative" data-name="Container">
      <p className="font-['Roboto_Mono:Medium',sans-serif] font-medium leading-[1.5] relative shrink-0 text-[#f3dfd8] text-[18px] uppercase w-full">Phone Number</p>
      <InputFeild1 />
    </div>
  );
}
...
function InputField7() {
  return (
    <div className="bg-[#1f1f1f] h-[163px] relative rounded-[12px] shrink-0 w-full" data-name="Input Field">
      <div aria-hidden="true" className="absolute border border-[#333] border-solid inset-0 pointer-events-none rounded-[12px]" />
...
function Container47() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 w-full" data-name="Container">
      <p className="font-['Roboto_Mono:Medium',sans-serif] font-medium leading-[1.5] relative shrink-0 text-[#f3dfd8] text-[18px] uppercase w-full">Message</p>
      <InputField7 />
    </div>
  );
}
...
function CheckBox() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[10px] items-center min-h-px min-w-px relative" data-name="Check Box">
      <div className="bg-[#262626] relative rounded-[7px] shrink-0 size-[28px]" data-name="Icon">
        <div aria-hidden="true" className="absolute border border-[#404040] border-solid inset-0 pointer-events-none rounded-[7px]" />
      </div>
...
function Icon27() {
  return (
    <div className="relative shrink-0 size-[28px]" data-name="Icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 28 28">
        <g id="Icon">
          <path clipRule="evenodd" d={svgPaths.p3261280} fill="var(--fill-0, #0F0F0F)" fillRule="evenodd" id="Vector 431 (Stroke)" />
        </g>
      </svg>
    </div>
  );
...
function Button33() {
  return (
    <div className="bg-[#ce7d63] content-stretch flex gap-[10px] items-center justify-center px-[34px] py-[18px] relative rounded-[12px] shrink-0" data-name="Button">
      <p className="font-['Roboto_Flex:Medium',sans-serif] font-medium leading-[1.5] not-italic relative shrink-0 text-[#0f0f0f] text-[18px] text-center uppercase whitespace-nowrap" style={{ fontVariationSettings: "'GRAD' 0, 'XOPQ' 96, 'XTRA' 468, 'YOPQ' 79, 'YTAS' 750, 'YTDE' -203, 'YTFI' 738, 'YTLC' 514, 'YTUC' 712, 'wdth' 100" }}>
        Send Your Message
      </p>
      <Icon27 />
...
function Container48() {
  return (
    <div className="content-stretch flex gap-[70px] items-center relative shrink-0 w-full" data-name="Container">
      <CheckBox />
      <Button33 />
    </div>
  );
...
function Form1() {
  return (
    <div className="bg-[#1a1a1a] flex-[1_0_0] min-h-px min-w-px relative rounded-[14px]" data-name="Form">
      <div className="content-stretch flex flex-col gap-[50px] items-start p-[50px] relative w-full">
        <ItemsContainer2 />
        <ItemsContainer3 />
        <Container47 />
        <Container48 />
...
function Container37() {
  return (
    <div className="absolute content-stretch flex gap-[20px] items-start left-[50px] top-[863px] w-[1820px]" data-name="Container">
      <SubContainer20 />
      <Form1 />
    </div>
  );
...
export default function ContactPageDesktop() {
  return (
    <div className="bg-[#0f0f0f] relative size-full" data-name="Contact Page - Desktop">
      <Navbar />
      <Container />
      <Container5 />
      <Container21 />
