import svgPaths from "./svg-x460ksdtzj";
...
function Button4() {
  return (
    <div className="bg-[#0f0f0f] content-stretch flex items-center px-[24px] py-[18px] relative rounded-[12px] shrink-0" data-name="Button">
      <p className="font-['Roboto_Mono:Medium',sans-serif] font-medium leading-[1.5] relative shrink-0 text-[#e7beb1] text-[18px] text-center uppercase whitespace-nowrap">Careers</p>
    </div>
  );
}
...
function TextContainer11() {
  return (
    <div className="bg-[#1a1a1a] relative rounded-[16px] shrink-0 w-full" data-name="TextContainer">
...
function BoldDesignToolsPipette() {
  return (
    <div className="relative shrink-0 size-[34px]" data-name="Bold / Design, Tools / Pipette">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 34 34">
        <g id="Bold / Design, Tools / Pipette">
          <g id="Vector">
            <path d={svgPaths.p155b7a00} fill="var(--fill-0, #CE7D63)" />
            <path d={svgPaths.p26324700} fill="var(--fill-0, #CE7D63)" />
          </g>
        </g>
      </svg>
    </div>
...
function IconContainer4() {
  return (
    <div className="bg-[#1f1f1f] content-stretch flex items-start p-[20px] relative rounded-[12px] shrink-0" data-name="Icon Container">
      <div aria-hidden="true" className="absolute border border-[#333] border-solid inset-0 pointer-events-none rounded-[12px]" />
...
function SubContainer17() {
  return (
    <div className="content-stretch flex gap-[10px] items-center relative shrink-0" data-name="Sub Container">
      <Button25 />
      <p className="font-['Roboto_Mono:Medium',sans-serif] font-medium leading-[1.5] relative shrink-0 text-[#b3b3b2] text-[20px] uppercase whitespace-nowrap">View Details</p>
    </div>
  );
}
...
function Container33() {
  return (
    <div className="content-start flex flex-wrap gap-[20px] items-start relative shrink-0 w-full" data-name="Container">
      <SubContainer18 />
      <SubContainer19 />
      <SubContainer20 />
    </div>
...
function BoldNatureTravelSuitcase() {
  return (
    <div className="relative shrink-0 size-[34px]" data-name="Bold / Nature, Travel / Suitcase">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 34 34">
        <g id="Bold / Nature, Travel / Suitcase">
          <path clipRule="evenodd" d={svgPaths.pa7cc270} fill="var(--fill-0, #CE7D63)" fillRule="evenodd" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function Container31() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[20px] items-start left-[50px] p-[20px] rounded-[24px] top-[767px] w-[1820px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-2 border-[#1f1f1f] border-solid inset-0 pointer-events-none rounded-[24px]" />
      <TextContainer11 />
      <ItemsContainer2 />
      <ItemsContainer3 />
...
function Container41() {
  return (
    <div className="content-stretch flex gap-[30px] items-center relative shrink-0 w-full" data-name="Container">
      <p className="font-['Roboto_Flex:SemiBold',sans-serif] font-semibold leading-[1.5] not-italic relative shrink-0 text-[#f9efec] text-[68px] uppercase whitespace-nowrap" style={{ fontVariationSettings: "'GRAD' 0, 'XOPQ' 96, 'XTRA' 468, 'YOPQ' 79, 'YTAS' 750, 'YTDE' -203, 'YTFI' 738, 'YTLC' 514, 'YTUC' 712, 'wdth' 100" }}>
...
function SubContainer36() {
  return (
    <div className="bg-[#1a1a1a] flex-[1_0_0] min-h-px min-w-px relative rounded-[20px]" data-name="Sub Container">
      <div className="flex flex-col items-center justify-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col gap-[4px] items-center justify-center px-[80px] py-[124px] relative w-full">
          <Container41 />
          <TextContainer16 />
        </div>
      </div>
...
function Card12() {
  return (
    <div className="bg-[#1a1a1a] content-stretch flex flex-col gap-[50px] items-start p-[50px] relative rounded-[14px] shrink-0 w-[593px]" data-name="Card">
      <TextContainer17 />
      <Container42 />
    </div>
  );
    ...
    <div className="relative shrink-0 w-full" data-name="Text Container">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center px-[30px] py-[16px] relative w-full">
          <p className="flex-[1_0_0] font-['Roboto_Mono:Regular',sans-serif] font-normal leading-[1.5] min-h-px min-w-px relative text-[#81807e] text-[20px]">Step 01</p>
        </div>
      </div>
    </div>
  );
...
function SubContainer37() {
  return (
    <div className="content-stretch flex gap-[10px] items-center relative shrink-0" data-name="Sub Container">
      <Button35 />
      <p className="font-['Roboto_Mono:Medium',sans-serif] font-medium leading-[1.5] relative shrink-0 text-[#b3b3b2] text-[18px] uppercase whitespace-nowrap">Know More</p>
    </div>
  );
}
...
function Container44() {
  return (
    <div className="relative shrink-0 w-full" data-name="Container">
      <div aria-hidden="true" className="absolute border-[#262626] border-solid border-t-2 inset-0 pointer-events-none" />
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col gap-[30px] items-start justify-center p-[30px] relative w-full">
          <p className="font-['Roboto_Flex:Regular',sans-serif] font-normal leading-[1.5] min-w-full not-italic relative shrink-0 text-[#b3b3b2] text-[18px] w-[min-content]" style={{ fontVariationSettings: "'GRAD' 0, 'XOPQ' 96, 'XTRA' 468, 'YOPQ' 79, 'YTAS' 750, 'YTDE' -203, 'YTFI' 738, 'YTLC' 514, 'YTUC' 712, 'wdth' 100" }}>{`Visit our website's "Careers" page to explore the current job listings. Review the various roles available and select the position that aligns with your skills, experience, and career aspirations.`}</p>
          <SubContainer37 />
        </div>
      </div>
    </div>
...
function TextContainer21() {
  return (
    <div className="relative shrink-0 w-full" data-name="Text Container">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center px-[30px] py-[16px] relative w-full">
          <p className="flex-[1_0_0] font-['Roboto_Mono:Regular',sans-serif] font-normal leading-[1.5] min-h-px min-w-px relative text-[#81807e] text-[20px]">Step 02</p>
        </div>
      </div>
    </div>
  );
...
function Container45() {
  return (
    <div className="relative shrink-0 w-full" data-name="Container">
      ...
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col gap-[30px] items-start justify-center p-[30px] relative w-full">
          <p className="font-['Roboto_Flex:Regular',sans-serif] font-normal leading-[1.5] min-w-full not-italic relative shrink-0 text-[#b3b3b2] text-[18px] w-[min-content]" style={{ fontVariationSettings: "'GRAD' 0, 'XOPQ' 96, 'XTRA' 468, 'YOPQ' 79, 'YTAS' 750, 'YTDE' -203, 'YTFI' 738, 'YTLC' 514, 'YTUC' 712, 'wdth' 100" }}>
...
function TextContainer23() {
  return (
    <div className="relative shrink-0 w-full" data-name="Text Container">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center px-[30px] py-[16px] relative w-full">
          <p className="flex-[1_0_0] font-['Roboto_Mono:Regular',sans-serif] font-normal leading-[1.5] min-h-px min-w-px relative text-[#81807e] text-[20px]">Step 03</p>
        </div>
      </div>
    </div>
  );
...
function Container46() {
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative w-full" data-name="Container">
      <div aria-hidden="true" className="absolute border-[#262626] border-solid border-t-2 inset-0 pointer-events-none" />
      <div className="content-stretch flex flex-col items-start justify-between p-[30px] relative size-full">
        <p className="font-['Roboto_Flex:Regular',sans-serif] font-normal leading-[1.5] min-w-full not-italic relative shrink-0 text-[#b3b3b2] text-[18px] w-[min-content]" style={{ fontVariationSettings: "'GRAD' 0, 'XOPQ' 96, 'XTRA' 468, 'YOPQ' 79, 'YTAS' 750, 'YTDE' -203, 'YTFI' 738, 'YTLC' 514, 'YTUC' 712, 'wdth' 100" }}>
...
function Card15() {
  return (
    <div className="bg-[#1a1a1a] content-stretch flex flex-[1_0_0] flex-col items-start min-h-px min-w-px overflow-clip relative rounded-[14px] self-stretch" data-name="Card">
      <TextContainer23 />
      <TextContainer24 />
      <Container46 />
    </div>
...
function TextContainer25() {
  return (
    <div className="relative shrink-0 w-full" data-name="Text Container">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center px-[30px] py-[16px] relative w-full">
          <p className="flex-[1_0_0] font-['Roboto_Mono:Regular',sans-serif] font-normal leading-[1.5] min-h-px min-w-px relative text-[#81807e] text-[20px]">Step 04</p>
        </div>
      </div>
    </div>
  );
...
function TextContainer27() {
  return (
    <div className="relative shrink-0 w-full" data-name="Text Container">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center px-[30px] py-[16px] relative w-full">
          <p className="flex-[1_0_0] font-['Roboto_Mono:Regular',sans-serif] font-normal leading-[1.5] min-h-px min-w-px relative text-[#81807e] text-[20px]">Step 05</p>
        </div>
      </div>
    </div>
  );
...
function TextContainer29() {
  return (
    <div className="relative shrink-0 w-full" data-name="Text Container">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center px-[30px] py-[16px] relative w-full">
          <p className="flex-[1_0_0] font-['Roboto_Mono:Regular',sans-serif] font-normal leading-[1.5] min-h-px min-w-px relative text-[#81807e] text-[20px]">Step 06</p>
        </div>
      </div>
    </div>
  );
...
function Container49() {
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative w-full" data-name="Container">
      <div aria-hidden="true" className="absolute border-[#262626] border-solid border-t-2 inset-0 pointer-events-none" />
      <div className="content-stretch flex flex-col items-start justify-between p-[30px] relative size-full">
        <p className="font-['Roboto_Flex:Regular',sans-serif] font-normal leading-[1.5] min-w-full not-italic relative shrink-0 text-[#b3b3b2] text-[18px] w-[min-content]" style={{ fontVariationSettings: "'GRAD' 0, 'XOPQ' 96, 'XTRA' 468, 'YOPQ' 79, 'YTAS' 750, 'YTDE' -203, 'YTFI' 738, 'YTLC' 514, 'YTUC' 712, 'wdth' 100" }}>{`Double-check all the information you provided to ensure accuracy and completeness. Once you are satisfied with your application, click the "Submit" button to send it to our HR team.`}</p>
        <SubContainer42 />
      </div>
    </div>
  );
...
function TextContainer31() {
  return (
    <div className="relative shrink-0 w-full" data-name="Text Container">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center px-[30px] py-[16px] relative w-full">
          <p className="flex-[1_0_0] font-['Roboto_Mono:Regular',sans-serif] font-normal leading-[1.5] min-h-px min-w-px relative text-[#81807e] text-[20px]">Step 07</p>
        </div>
      </div>
    </div>
  );
...
function TextContainer33() {
  return (
    <div className="relative shrink-0 w-full" data-name="Text Container">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center px-[30px] py-[16px] relative w-full">
          <p className="flex-[1_0_0] font-['Roboto_Mono:Regular',sans-serif] font-normal leading-[1.5] min-h-px min-w-px relative text-[#81807e] text-[20px]">Step 08</p>
        </div>
      </div>
    </div>
  );
...
function Container43() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[20px] items-start left-[50px] p-[20px] rounded-[24px] top-[2135px] w-[1820px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-2 border-[#1f1f1f] border-solid inset-0 pointer-events-none rounded-[24px]" />
      <TextContainer18 />
      <ItemsContainer4 />
      <ItemsContainer5 />
...
export default function CareersPageDesktop() {
  return (
    <div className="bg-[#0f0f0f] relative size-full" data-name="Careers Page - Desktop">
      <Navbar />
      <Container />
      <Container5 />
      <Container21 />
