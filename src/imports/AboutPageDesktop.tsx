import svgPaths from "./svg-q6bosrd7sf";
...
import imgImage4 from "figma:asset/87fae8960d3aa4b1cf615ab5d9c08c511d80086c.png";
import imgImage5 from "figma:asset/41fe3c52e41109c095c3f163fa6ccbd416dc8fd1.png";
import imgImage6 from "figma:asset/0f9ce0f6c94e6c8a3b5b0a4e2475ceb41b1cd6f7.png";
import imgImage7 from "figma:asset/ea0360ad0d901c91e4f3e9062c5d10485fe1946b.png";
...
function Button3() {
  return (
    <div className="bg-[#0f0f0f] content-stretch flex items-center px-[24px] py-[18px] relative rounded-[12px] shrink-0" data-name="Button">
      <p className="font-['Roboto_Mono:Medium',sans-serif] font-medium leading-[1.5] relative shrink-0 text-[#e7beb1] text-[18px] text-center uppercase whitespace-nowrap">About</p>
    </div>
  );
}
...
function TextContainer2() {
  return (
    <div className="relative shrink-0 w-full" data-name="Text Container">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center px-[30px] py-[16px] relative w-full">
          <p className="flex-[1_0_0] font-['Roboto_Mono:Regular',sans-serif] font-normal leading-[1.5] min-h-px min-w-px relative text-[#81807e] text-[20px]">September 2023</p>
        </div>
      </div>
    </div>
  );
...
function TextContainer3() {
  return (
    <div className="bg-[#1f1f1f] relative shrink-0 w-full" data-name="Text Container">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center px-[30px] py-[40px] relative w-full">
...
function TextContainer4() {
  return (
    <div className="relative shrink-0 w-full" data-name="Text Container">
      <div aria-hidden="true" className="absolute border-[#262626] border-solid border-t-2 inset-0 pointer-events-none" />
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center p-[30px] relative w-full">
          <div className="flex-[1_0_0] font-['Roboto_Flex:Regular',sans-serif] font-normal leading-[1.5] min-h-px min-w-px not-italic relative text-[#b3b3b2] text-[18px]" style={{ fontVariationSettings: "'GRAD' 0, 'XOPQ' 96, 'XTRA' 468, 'YOPQ' 79, 'YTAS' 750, 'YTDE' -203, 'YTFI' 738, 'YTLC' 514, 'YTUC' 712, 'wdth' 100" }}>
            <p className="mb-0">In 2023, our software engineering agency gained global acclaim for innovative solutions, setting new standards in the ever-evolving software landscape.</p>
            <p>&nbsp;</p>
          </div>
        </div>
      </div>
...
function Card() {
  return (
    <div className="bg-[#1a1a1a] content-stretch flex flex-[1_0_0] flex-col items-start min-h-px min-w-px overflow-clip relative rounded-[14px]" data-name="Card">
      <TextContainer2 />
      <TextContainer3 />
      <TextContainer4 />
    </div>
...
function TextContainer5() {
  return (
    <div className="relative shrink-0 w-full" data-name="Text Container">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center px-[30px] py-[16px] relative w-full">
          <p className="flex-[1_0_0] font-['Roboto_Mono:Regular',sans-serif] font-normal leading-[1.5] min-h-px min-w-px relative text-[#81807e] text-[20px]">March 2019</p>
        </div>
      </div>
    </div>
  );
...
function TextContainer8() {
  return (
    <div className="relative shrink-0 w-full" data-name="Text Container">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center px-[30px] py-[16px] relative w-full">
          <p className="flex-[1_0_0] font-['Roboto_Mono:Regular',sans-serif] font-normal leading-[1.5] min-h-px min-w-px relative text-[#81807e] text-[20px]">August 2015</p>
        </div>
      </div>
    </div>
  );
...
function TextContainer11() {
  return (
    <div className="relative shrink-0 w-full" data-name="Text Container">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center px-[30px] py-[16px] relative w-full">
          <p className="flex-[1_0_0] font-['Roboto_Mono:Regular',sans-serif] font-normal leading-[1.5] min-h-px min-w-px relative text-[#81807e] text-[20px]">January 2010</p>
        </div>
      </div>
    </div>
  );
...
function Container5() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[20px] items-start left-[50px] top-[1641px] w-[1820px]" data-name="Container">
      <TextContainer1 />
      <ItemsContainer1 />
    </div>
  );
...
function SubContainer17() {
  return (
    <div className="bg-[#1a1a1a] content-stretch flex items-start p-[20px] relative rounded-[100px] shrink-0" data-name="Sub Container">
      <div aria-hidden="true" className="absolute border border-[#262626] border-solid inset-0 pointer-events-none rounded-[100px]" />
      <Icon21 />
    </div>
  );
...
function Container33() {
  return (
    <div className="content-stretch flex gap-[10px] items-center relative shrink-0" data-name="Container">
      <SubContainer17 />
      <p className="font-['Roboto_Mono:Medium',sans-serif] font-medium leading-[1.5] relative shrink-0 text-[#b3b3b2] text-[20px] uppercase whitespace-nowrap">ALL Members</p>
    </div>
  );
}
...
function TextContainer24() {
  return (
    <div className="bg-[#262626] mb-[-110px] relative shrink-0 w-full" data-name="Text Container">
      <div className="flex flex-col items-center size-full">
        <div className="content-stretch flex flex-col gap-[4px] items-center leading-[1.5] not-italic pb-[150px] pt-[50px] px-[50px] relative text-center w-full">
          <p className="font-['Roboto_Flex:Medium',sans-serif] font-medium relative shrink-0 text-[#f9efec] text-[24px] uppercase w-full" style={{ fontVariationSettings: "'GRAD' 0, 'XOPQ' 96, 'XTRA' 468, 'YOPQ' 79, 'YTAS' 750, 'YTDE' -203, 'YTFI' 738, 'YTLC' 514, 'YTUC' 712, 'wdth' 100" }}>
            John Smith
          </p>
          <p className="font-['Roboto_Flex:Regular',sans-serif] font-normal relative shrink-0 text-[#b3b3b2] text-[18px] w-full" style={{ fontVariationSettings: "'GRAD' 0, 'XOPQ' 96, 'XTRA' 468, 'YOPQ' 79, 'YTAS' 750, 'YTDE' -203, 'YTFI' 738, 'YTLC' 514, 'YTUC' 712, 'wdth' 100" }}>{`Co-Founder & CEO`}</p>
        </div>
      </div>
    </div>
  );
...
function Icon22() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="Icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="Icon">
          <path d={svgPaths.p38d6cc30} fill="var(--fill-0, #E7BEB1)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function Icon23() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="Icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="Icon">
          <path d={svgPaths.p3da43780} fill="var(--fill-0, #E7BEB1)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function Icon24() {
  return (
    <div className="overflow-clip relative shrink-0 size-[24px]" data-name="Icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="Group">
          <path d={svgPaths.p2ccee40} fill="var(--fill-0, #E7BEB1)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function ButtonsContainer1() {
  return (
    <div className="content-stretch flex gap-[10px] items-center justify-center relative shrink-0 w-full" data-name="Buttons Container">
      <Button25 />
      <Button26 />
      <Button27 />
    </div>
...
function Container34() {
  return (
    <div className="mb-[-110px] relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col items-center size-full">
        <div className="content-stretch flex flex-col gap-[30px] items-center pb-[40px] px-[30px] relative w-full">
          <div className="h-[211px] relative rounded-[12px] shrink-0 w-full" data-name="Image">
            <div aria-hidden="true" className="absolute inset-0 pointer-events-none rounded-[12px]">
              <div className="absolute bg-[#e7beb1] inset-0 rounded-[12px]" />
              <img alt="" className="absolute max-w-none object-cover rounded-[12px] size-full" src={imgImage4} />
            </div>
          </div>
          <ButtonsContainer1 />
        </div>
...
function Card12() {
  return (
    <div className="bg-[#1a1a1a] content-stretch flex flex-[1_0_0] flex-col items-start min-h-px min-w-px overflow-clip pb-[110px] relative rounded-[14px]" data-name="Card">
      <TextContainer24 />
      <Container34 />
    </div>
  );
      ...
      <div className="flex flex-col items-center size-full">
        <div className="content-stretch flex flex-col gap-[30px] items-center pb-[40px] px-[30px] relative w-full">
          <div className="h-[211px] relative rounded-[12px] shrink-0 w-full" data-name="Image">
            <div aria-hidden="true" className="absolute inset-0 pointer-events-none rounded-[12px]">
              <div className="absolute bg-[#e7beb1] inset-0 rounded-[12px]" />
              <img alt="" className="absolute max-w-none object-cover rounded-[12px] size-full" src={imgImage5} />
            </div>
          </div>
          <ButtonsContainer2 />
        </div>
...
function Container32() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[20px] items-start left-[50px] p-[20px] rounded-[24px] top-[803px] w-[1820px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-2 border-[#1f1f1f] border-solid inset-0 pointer-events-none rounded-[24px]" />
      <SubContainer16 />
      <ItemsContainer3 />
    </div>
...
function SubContainer19() {
  return (
    <div className="bg-[#1a1a1a] content-stretch flex flex-col gap-[50px] items-center justify-center pb-[50px] pt-[20px] px-[20px] relative rounded-[14px] shrink-0 w-[593px]" data-name="Sub Container">
      <Container40 />
      <Container41 />
    </div>
  );
    ...
    <div className="bg-[#1a1a1a] relative rounded-[16px] shrink-0 w-full" data-name="Text Container">
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col items-start justify-center pl-[50px] pr-[300px] py-[50px] relative w-full">
          <p className="font-['Roboto_Flex:SemiBold',sans-serif] font-semibold leading-[normal] not-italic relative shrink-0 text-[#f9efec] text-[48px] uppercase w-full" style={{ fontVariationSettings: "'GRAD' 0, 'XOPQ' 96, 'XTRA' 468, 'YOPQ' 79, 'YTAS' 750, 'YTDE' -203, 'YTFI' 738, 'YTLC' 514, 'YTUC' 712, 'wdth' 100" }}>{`Awards & Recognitions`}</p>
        </div>
      </div>
    </div>
  );
...
function TextContainer34() {
  return (
    <div className="bg-[#262626] content-stretch flex gap-[8px] items-center px-[16px] py-[10px] relative rounded-[45px] shrink-0" data-name="Text Container">
...
function BoldLikeMedalStar() {
  return (
    <div className="relative shrink-0 size-[34px]" data-name="Bold / Like / Medal Star">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 34 34">
        <g id="Bold / Like / Medal Star">
          <path clipRule="evenodd" d={svgPaths.p2ab27300} fill="var(--fill-0, #CE7D63)" fillRule="evenodd" id="Vector" />
          <path d={svgPaths.p20cf5100} fill="var(--fill-0, #CE7D63)" id="Vector_2" />
        </g>
      </svg>
    </div>
  );
...
function Card16() {
  return (
    <div className="bg-[#1a1a1a] flex-[1_0_0] min-h-px min-w-px relative rounded-[14px]" data-name="Card">
      <div className="content-stretch flex flex-col gap-[50px] items-start p-[40px] relative w-full">
        <Container43 />
        <TextContainer35 />
      </div>
    </div>
...
function TextContainer39() {
  return (
    <div className="content-stretch flex flex-col gap-[12px] items-start leading-[1.5] not-italic relative shrink-0 w-full" data-name="Text Container">
      <p className="font-['Roboto_Flex:Medium',sans-serif] font-medium relative shrink-0 text-[#f9efec] text-[30px] uppercase w-full" style={{ fontVariationSettings: "'GRAD' 0, 'XOPQ' 96, 'XTRA' 468, 'YOPQ' 79, 'YTAS' 750, 'YTDE' -203, 'YTFI' 738, 'YTLC' 514, 'YTUC' 712, 'wdth' 100" }}>
        Best Quality Engineering Campaign
      </p>
      <p className="font-['Roboto_Flex:Regular',sans-serif] font-normal relative shrink-0 text-[#b3b3b2] text-[18px] w-full" style={{ fontVariationSettings: "'GRAD' 0, 'XOPQ' 96, 'XTRA' 468, 'YOPQ' 79, 'YTAS' 750, 'YTDE' -203, 'YTFI' 738, 'YTLC' 514, 'YTUC' 712, 'wdth' 100" }}>
        Awarded for an exceptional Quality Engineering campaign with outstanding results, showcasing our data-driven strategies and targeted marketing efforts that achieved remarkable business growth for our clients.
      </p>
    </div>
  );
}
...
function Container42() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[20px] items-start left-[50px] p-[20px] rounded-[24px] top-[2319px] w-[1820px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-2 border-[#1f1f1f] border-solid inset-0 pointer-events-none rounded-[24px]" />
      <TextContainer33 />
      <ItemsContainer4 />
    </div>
...
export default function AboutPageDesktop() {
  return (
    <div className="bg-[#0f0f0f] relative size-full" data-name="About Page - Desktop">
      <Navbar />
      <Container />
      <Container5 />
      <Container6 />
