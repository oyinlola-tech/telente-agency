import svgPaths from "./svg-1ika3ny4c5";
...
import imgImage4 from "figma:asset/ffaf3990ee6cf0ca83ddafefa5b9715854ba49ef.png";
import imgImage5 from "figma:asset/58ae4ec59106469eb2ba1094f3c07ee4967cdf5f.png";
import imgImage6 from "figma:asset/aa8619168ff3982a08bd40e6c02a2f0cd1835c8a.png";
import imgImage7 from "figma:asset/c00a56a9af37a6e5beaf7f1ff90969276c7dd6f2.png";
...
function Container34() {
  return (
    <div className="content-stretch flex gap-[10px] items-center relative shrink-0" data-name="Container">
      <Button28 />
      <p className="font-['Roboto_Mono:Medium',sans-serif] font-medium leading-[1.5] relative shrink-0 text-[#b3b3b2] text-[20px] uppercase whitespace-nowrap">Read Full Blog</p>
    </div>
  );
}
...
function TextContainer14() {
  return (
    <div className="content-stretch flex gap-[12px] items-center leading-[1.5] not-italic relative shrink-0 whitespace-nowrap" data-name="Text Container">
      <p className="font-['Roboto_Flex:Regular',sans-serif] font-normal relative shrink-0 text-[#b3b3b2] text-[18px]" style={{ fontVariationSettings: "'GRAD' 0, 'XOPQ' 96, 'XTRA' 468, 'YOPQ' 79, 'YTAS' 750, 'YTDE' -203, 'YTFI' 738, 'YTLC' 514, 'YTUC' 712, 'wdth' 100" }}>
        Published Date
      </p>
      <p className="font-['Roboto_Flex:Medium',sans-serif] font-medium relative shrink-0 text-[#f9efec] text-[24px] uppercase" style={{ fontVariationSettings: "'GRAD' 0, 'XOPQ' 96, 'XTRA' 468, 'YOPQ' 79, 'YTAS' 750, 'YTDE' -203, 'YTFI' 738, 'YTLC' 514, 'YTUC' 712, 'wdth' 100" }}>
        7th February 2023
      </p>
    </div>
  );
...
function SubContainer17() {
  return (
    <div className="content-stretch flex gap-[20px] items-center relative shrink-0 w-full" data-name="Sub Container">
      <div className="flex flex-row items-center self-stretch">
        <div className="h-full relative rounded-[14px] shrink-0 w-[573px]" data-name="Image">
...
function Container31() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[20px] items-start left-[50px] p-[20px] rounded-[24px] top-[191px] w-[1820px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-2 border-[#1f1f1f] border-solid inset-0 pointer-events-none rounded-[24px]" />
      <SubContainer16 />
      <SubContainer17 />
      <ItemsContainer2 />
...
export default function BlogsPageDesktop() {
  return (
    <div className="bg-[#0f0f0f] relative size-full" data-name="Blogs Page - Desktop">
      <Navbar />
      <Container />
      <Container5 />
      <Container21 />
